...
public class ProductServer {
    private final AddToCartController controller;
    private final ProductRepository productRepository;
    private final ProductController productController;
    private final Scanner scanner;

    public ProductServer(AddToCartController addToCartController, ProductRepository productRepository) {
        this.controller = addToCartController;
    ...
    private void displayMenu() {
        ...
        System.out.println("12. Remove Product From Cart");
    ...
    private void handleMenuChoice(int choice) throws SQLException {
        switch (choice) {
            case 1:
                createProduct();
                break;
...
//    }
    ...
    private void showAddToCartUI() {
        ...
        controller.addToCartByInput(uuid, qty);
    }

    private void showCartUI() throws SQLException {
        System.out.println("\n--- Your Cart ---");
        controller.viewCart();
    }

    private void showRemoveFromCartUI() throws SQLException {
