...
public class UserServiceImpl implements UserService {
    ...
    public UserResponseDto register(UserCreateDto user) {
        Users entity = UserMapper.mapFromUserCreateDto(user);
        return UserMapper.mapToUserResponseDto(userRepository.save(entity));
    }
    ...
    public UserResponseDto getUserByUuid(String uuid) {
        try {
            return UserMapper.mapToUserResponseDto(userRepository.findByUserUuid(uuid));
